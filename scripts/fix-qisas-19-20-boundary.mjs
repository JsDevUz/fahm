...
chapters[19].sentences = [...chapters[19].sentences, ...chapters[20].sentences];
words[19] = { ...words[19], ...words[20] };

for (let i = 21; i < oldLength; i += 1) {
...
console.log('Merged old chapter 20 into chapter 19 and shifted following qisas chapters down by one');
