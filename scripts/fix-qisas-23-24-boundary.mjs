...
chapters[21].sentences = [...chapters[21].sentences, ...chapters[22].sentences];
words[21] = { ...words[21], ...words[22] };

for (let i = 23; i < oldLength; i += 1) {
...
console.log('Merged old chapter 24 into chapter 23 and shifted following qisas chapters down by one');
